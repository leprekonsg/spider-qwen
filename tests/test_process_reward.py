...
def test_perfect_service_bundle_scores_one():
    b = _bundle(
        ...
        dict(service_match=1, quote_channel=1, geo=1, checklist=1, evidence_quality=1,
             qualified_supplier_coverage=1, evidence_diversity=1),
    )
...
def test_missing_quote_channel_lowers_service_reward_by_its_weight():
    ...
    no_qc = _bundle("service_quote_required", TrajectoryStrategy.OFFICIAL_SITE_FIRST,
                    dict(service_match=1, quote_channel=0, geo=1, checklist=1, evidence_quality=1,
                         qualified_supplier_coverage=1, evidence_diversity=1))
...
def test_electronics_uses_electronics_weights_and_counterfeit_penalty():
    ...
    b = _bundle("electronics_substitution", TrajectoryStrategy.FFF_SUBSTITUTE_FIRST,
                dict(fff_similarity=1, lifecycle_safety=1, authorized_source=1, stock=1, datasheet_evidence=1,
                     risk=1, qualified_supplier_coverage=1),
